...
import com.kitchen.sales.order.domain.order.aggregate.OrderBuilder;
...
public class OrderEntity extends AbstractAuditingEntity<Long> {
  ...
  public static OrderEntity fromDomain(Order order){
    Set<OrderedProductEntity> orderedProductEntities = order.getOrderedProducts().stream().map(OrderedProductEntity::fromDomain).collect(Collectors.toSet());
  ...
  public static Order toDomain(OrderEntity orderEntity){
    Set<OrderedProduct> orderedProducts =
      orderEntity.getOrderedProducts().stream().map(OrderedProductEntity::toDomain).collect(Collectors.toSet());
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getPublicId(), that.getPublicId()) && getStatus() == that.getStatus() && Objects.equals(getStripeSessionId(), that.getStripeSessionId());
  }

  @Override
  public int hashCode() {
    return Objects.hash(getPublicId(), getStatus(), getStripeSessionId());
  }
}
