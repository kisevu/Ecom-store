package com.kitchen.sales.config.Authentication.application;

import com.kitchen.sales.config.Authentication.domain.Role;
import com.kitchen.sales.config.Authentication.domain.Roles;
import com.kitchen.sales.config.Authentication.domain.Username;
...
public final class AuthenticatedUser {
  ...
  public static String readPrincipal(Authentication authentication) {
    ...
    if (authentication instanceof JwtAuthenticationToken token) {
      return (String) token.getToken().getClaims().get(PREFERRED_USERNAME);  // retrieves user name from the jwt token
    }
